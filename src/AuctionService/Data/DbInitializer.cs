...
public class DbInitializer
{
    ...
    {
        //manually create scope, since this is startup code, runs before app.Run()
    ...
    {
        //applies all pending migrations to the database and creates it if not already created
        dbContext.Database.Migrate();
        if (dbContext.Auctions.Any())
        {
            //no need to seed if db is not empty
            return;
        }
